    ...
    html: `
      <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#0f172a;color:#e2e8f0;border-radius:12px;overflow:hidden;">
        <div style="background:linear-gradient(135deg,#38bdf8,#818cf8);padding:28px 32px;">
          ...
          <p style="margin:6px 0 0;color:rgba(255,255,255,0.85);font-size:14px;">Someone reached out via your portfolio contact form</p>
        </div>
        <div style="padding:32px;">
          <table style="width:100%;border-collapse:collapse;margin-bottom:24px;">
            <tr><td style="padding:10px 14px;background:#1e293b;border-radius:8px 8px 0 0;border-bottom:1px solid #334155;">
              <span style="font-size:11px;color:#64748b;text-transform:uppercase;">Name</span><br/>
              <span style="font-size:15px;font-weight:600;color:#f1f5f9;">${name}</span>
            </td></tr>
            <tr><td style="padding:10px 14px;background:#1e293b;border-bottom:1px solid #334155;">
              <span style="font-size:11px;color:#64748b;text-transform:uppercase;">Email</span><br/>
              <a href="mailto:${email}" style="font-size:15px;color:#38bdf8;text-decoration:none;">${email}</a>
            </td></tr>
            <tr><td style="padding:10px 14px;background:#1e293b;border-radius:0 0 8px 8px;">
              <span style="font-size:11px;color:#64748b;text-transform:uppercase;">Subject</span><br/>
          ...
          <div style="background:#1e293b;border-radius:8px;padding:18px;border-left:3px solid #38bdf8;">
            <span style="font-size:11px;color:#64748b;text-transform:uppercase;display:block;margin-bottom:10px;">Message</span>
